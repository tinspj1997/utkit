...
| `access_key_id` | `Optional[str]` | R2 access key ID |
...
|---|---|
| `R2_ACCOUNT_ID` | Cloudflare R2 account ID (alternative to parameter) |
| `R2_ACCESS_KEY_ID` | R2 access key ID (alternative to parameter) |
